...
|3|NPC|<img src="./img/으왈컹_주인공.png" width="300">|
|4|옷장|<img src="./img/으왈컹_옷장" width="300">|  
|5|선택지|<img src="./img/으왈컹_선택지화면.png" width="300">|  
|6|스케쥴|<img src="./img/으왈컹_스케쥴화면.png" width="300">|  
...
|이름|시트린|설명|
|나이|15|설명|
|스트레스|0~100|상태요소 생각해보기|
|능력치|0~1000|[ 개 능력 / 신체 능력 / 마법 능력 / 지식 ] 다섯갈래의 능력치가 있음. 일주일에 2개의 능력치를 올릴 수 있음. 하루에 10포인트씩 획득|
...
|속성|속성값|설명|비고|
|-----|:-----:|-----|-----|
|npc호감도| ? |특정 주차에 특정 장소에 가면 npc를 만날 수 있음. npc와 대화하면 해당 npc의 호감도가 오름|
|능력치| ? |특정 주차에 특정 장소에 가면 이벤트가 발생. 해당 이벤트와 관련된 능력치 소폭 상승|
|장소| (5가지, 미정)|주말마다 방문할 수 있음. 하루에 2번 방문 가능|
