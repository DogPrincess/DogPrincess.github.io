...
* 2주차
    - 프로그래밍
        + 메인 화면, 능력치 화면 구성
        + 능력치(호감도) 수치 게이지창 구현
        + Current 정보를 저장하는 스크립트
        + OnClick / CurrentSt  
    - 그래픽
        + GUI 규격 설정
* 3주차
    - 프로그래밍
        + 스케쥴 화면 구성, 스케쥴 설정 기능 구현
        + OnClick / StatUp / SetSch 
    - 그래픽
* 4주차
    - 프로그래밍
        + 마을 화면 구성
        + 아이콘 클릭 시 화면 전환 기능 구현, 외출 종료 기능 구현
        + OnClick / ExitVisit 
    - 그래픽
        + 마을 아이콘 디자인 
* 5주차
    - 프로그래밍
        + 상점, 성당 기능 구현 / 인벤토리 화면 구성
        + 일반 아이템 탭 구현
        + Current 정보를 저장하는 스크립트
        + ItemStore / CurrentDon / CurrentItemCount
    - 그래픽
* 6주차
    - 프로그래밍
        + 인벤토리 의상 기능 구현, 탭 기능 구현
        + 아이템 사용 기능 구현
    - 그래픽
        + 아이템 아이콘 디자인
